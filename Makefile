...
GAME_TITLE	    :=	NDS Snake CPP
GAME_SUBTITLE1	:= 	The best snake in the world
GAME_SUBTITLE2	:=	I swear
...
BUILD		:=	build
SOURCES		:=	src App HelperFunctions Snake
INCLUDES	:=	include HelperFunctions App Snake
DATA		:=	data
